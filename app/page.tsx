...
const features = [
  {
    ...
    description:
      "Not just links. Lookinit reads the web and synthesizes a direct, cited answer from multiple sources.",
  },
  {
    icon: <Globe size={22} />,
    title: "Live Web Results",
    description:
      "Pulls from real-time search across the open web — news, blogs, docs, and more. Always fresh.",
  },
  {
    icon: <Zap size={22} />,
    title: "Multiple AI Models",
    description:
      "Switch between Groq, Claude, Mistral, DeepSeek, and more. Pick the model that fits the task.",
  },
  {
    icon: <Image size={22} />,
    title: "Images & Videos",
    description:
      "Relevant visuals automatically surfaced alongside every answer. No extra searching needed.",
  },
  {
    icon: <MessageSquare size={22} />,
    title: "Follow-up Questions",
    description:
      "AI suggests what to ask next. Dig deeper without starting over — conversation-style search.",
  },
  {
    icon: <Shield size={22} />,
    title: "Search History",
    description:
      "Every search saved to your account. Pick up where you left off, anytime, from any device.",
  },
];
            ...
            {[
              {
                step: "01",
                title: "Ask anything",
                desc: "Type your question naturally. No keywords, no boolean operators. Just ask like you would a person.",
              },
              {
                step: "02",
                title: "AI reads the web",
                desc: "Lookinit searches the live web, scrapes relevant pages, and vectorizes the content in real time.",
              },
              {
                step: "03",
                title: "Get a real answer",
                desc: "A cited, structured answer streams back in seconds. With images, follow-ups, and source links.",
              },
            ].map((item) => (
              <div key={item.step}>
                <div
